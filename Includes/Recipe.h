...
#include "InstantCamera.h" // for ETimeoutHandling
#include "WaitObject.h" // for Infinite

#include "PylonDataProcessing.h"
#include "VariantDataType.h"
#include "IParameterCollection.h"
#include "Update.h"
